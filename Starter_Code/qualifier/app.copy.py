...
def save_qualifying_loans(qualifying_loans):
    ...
    """
    cvspath = questionary.text(
        "Would you like to save your qualifying loan information?").ask()
    csvpath = Path(csvpath)
    if not csvpath.exist():
        sys.exit(f"Information deleted.")
    return load_csv(csvpath)

# Integrated save function into existing loan qualifier
